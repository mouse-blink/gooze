...
func TestWorkflow_Test_Success(t *testing.T) {
	...
	mockMutagen.EXPECT().GenerateMutation(mock.Anything, mock.Anything, domain.DefaultMutations[0], domain.DefaultMutations[1], domain.DefaultMutations[2], domain.DefaultMutations[3]).Return(mutations, nil)
...
func TestWorkflow_Test_GenerateMutationsError(t *testing.T) {
	...
	mockUI.EXPECT().DisplayConcurencyInfo(mock.Anything, mock.Anything, mock.Anything).Return()
	mockFSAdapter.EXPECT().Get(mock.Anything).Return(sources, nil)
	mockMutagen.EXPECT().GenerateMutation(mock.Anything, mock.Anything, domain.DefaultMutations[0], domain.DefaultMutations[1], domain.DefaultMutations[2], domain.DefaultMutations[3]).Return(nil, testErr)
...
func TestWorkflow_Test_NoMutations(t *testing.T) {
	...
	mockUI.EXPECT().DusplayUpcomingTestsInfo(mock.Anything).Return()
	mockFSAdapter.EXPECT().Get(mock.Anything).Return(sources, nil)
	mockMutagen.EXPECT().GenerateMutation(mock.Anything, mock.Anything, domain.DefaultMutations[0], domain.DefaultMutations[1], domain.DefaultMutations[2], domain.DefaultMutations[3]).Return([]m.Mutation{}, nil)
...
func TestWorkflow_Test_MultipleSources(t *testing.T) {
	...
	mockMutagen.EXPECT().GenerateMutation(source1, 0, domain.DefaultMutations[0], domain.DefaultMutations[1], domain.DefaultMutations[2], domain.DefaultMutations[3]).Return(mutations1, nil)
	mockMutagen.EXPECT().GenerateMutation(source2, 2, domain.DefaultMutations[0], domain.DefaultMutations[1], domain.DefaultMutations[2], domain.DefaultMutations[3]).Return(mutations2, nil)
	mockOrchestrator.EXPECT().TestMutation(mock.Anything).Return(m.Result{}, nil).Times(3)
	mockReportStore.EXPECT().SaveReports(mock.Anything, mock.MatchedBy(func(reports []m.Report) bool {
		return len(reports) == 3
	})).Return(nil)
