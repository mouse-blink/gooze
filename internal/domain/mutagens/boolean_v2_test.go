...
func TestGenerateBooleanMutationsV2(t *testing.T) {
	...
	ast.Inspect(file, func(n ast.Node) bool {
		mutations = append(mutations, GenerateBooleanMutationsV2(n, fset, content, source, &mutationID)...)
		return true
	})
...
func TestIsBooleanLiteralV2(t *testing.T) {
	tests := []struct {
		name     string
		expected bool
	}{
